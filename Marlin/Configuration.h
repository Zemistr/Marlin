...
#define STRING_CONFIG_H_AUTHOR "(Martin Zeman (Zemistr), Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Your Bitch"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 438.25, 403.35 } // Original = 93
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 25, 500, 500 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 500, 3000, 3000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.375   // Z offset: -below +above  [the nozzle]
